...
public enum Status {
	...
	INVALID_REGISTRATION("Invalid username and/or password."),
	INVALID_LOGIN("Invalid username and/or password."),
	INVALID_PASSWORD("Invalid password. Password should be 6-20 long and contains at least one digit, one upper letter, one lower letter and one special character"),
